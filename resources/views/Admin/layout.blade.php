@php
    ...
    $notifications = \App\Models\Notification::where('is_readed' , 0)->latest()->get();
    if ($user->role == 1) {
        ...
        <div class="header header-one">
            ...
            <ul class="nav nav-tabs user-menu">
                ...
                <li class="nav-item dropdown  flag-nav dropdown-heads">
                    <a class="nav-link notificationbadge" data-bs-toggle="dropdown" href="#" role="button">
                        <i class="fe fe-bell"></i>@if($notifications->where('is_readed' , 0)->count() > 0)
                    ...
                    <div class="dropdown-menu notifications">
                        <div class="topnav-dropdown-header">
                            ...
                            <a href="javascript:void(0)" class="clear-noti markall d-flex align-items-center">Mark all as read
                        ...
                        <div class="noti-content">
                            <ul class="notification-list">
                                ...
                                <li class="notification-message">
                                    <a class="marknotification" data-id="{{ $item->id }}" href="{{ $item->route }}">
                                    <div class="d-flex">
                                    <div class="media-body">
                                    <p class="noti-details "><span class="noti-title h6">{{ $item->subject }} </span><br>
                                    <p class="noti-time"><span class="notification-time">{{ \Carbon\Carbon::parse($item->created_at)->format('d F, Y h:iA') }} </span></p>
                                    </div>
                                    </div>
                                    </a>
                                </li>
                                @empty
                               <li> <center>No Notifications Available</center></li>
                                @endforelse
