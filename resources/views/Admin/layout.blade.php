...
<li><a href="{{ route('dashboard') }}" class="active">Admin Dashboarsd</a></li>
<li class="submenu">
...
<li class="submenu">
    ...
    <ul style="display: none;">
        <li class="submenu">
            <a href="#"><i class="fe fe-sidebar"></i> <span> Side Bar menus </span> <span class="menu-arrow"></span></a>
            <ul style="display: none;">
            <li><a href="{{ route('menusettings.create') }}">Create</a></li>
            <li><a href="form-input-groups.html">All</a></li>
