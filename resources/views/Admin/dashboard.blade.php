...
@section('content')
        ...
        <div class="col-xl-3 col-sm-6 col-12">
                ...
                <div class="card-body">
                    <div class="dash-widget-header">
                        ...
                        <div class="dash-count row">
                            <div class="dash-title text-success">Check-in</div>
                            <div class="dash-counts">
                                <div class="time-container fw-bold d-flex">
                                    <span class="checkin-time">{{ $attendance->check_in ?? '00:00 AM' }}
                                    </span> &nbsp;<div class="checkin-meridiem"></div>
                                </div>
                            </div>
                        ...
                        <div class="dash-count row">
                            <div class="dash-title text-danger">Check-out</div>
                            <div class="dash-counts">
                                <div class="time-container fw-bold d-flex">
                                    <span class="checkout-time">{{ $attendance->check_out ?? '00:00 AM' }}
                                    </span> &nbsp;<div class="checkout-meridiem"></div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-10 d-flex">
                            @if (!empty($attendance->check_in) && !empty($attendance->check_out))
                                <p class="text-muted mt-3 mb-0 checkout-container"><span class="text-danger me-1"><i
                                            class="fa-regular fa-calendar-check"></i> Checked Out</span>&nbsp;</p>
                            @else
                                <p class="text-muted mt-3 mb-0 timer-container"><span class="text-primary me-1"><i
                                            class="fas fa-clock me-1"></i> Working Hours</span>&nbsp; <span
                                        class="time-calulation">
                        ...
                        <div class="col-md-2 ">
                            ...
                            <input type="hidden" class="checkInInput" value="{{ $attendance->check_in ?? '' }}">
                            <input type="hidden" class="workingHours">
                            <input type="hidden" class="checkOutInput"value="{{ $attendance->check_out ?? '' }}">
                            <button class="btn btn-success checkInBtn"
                                @if (!empty($attendance->check_in) && !empty($attendance->check_out)) disabled="true"
            ...
            @elseif(Auth::user()->role == 1)
                disabled="true" @endif>
                            ...
                            <button class="btn btn-danger checkoutBtn"
                                @if (empty($attendance->check_in) || !empty($attendance->check_out)) style="display:none"
            @elseif(Auth::user()->role == 1)
                disabled="true" @endif>
    ...
    @push('js')
        ...
        <script>
            ...
            let attendanceCheckout = "{{ route('attendance.checkout') }}";
        </script>
    @endpush
@endsection
